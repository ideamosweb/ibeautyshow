...
;(function ($) {
    ...
    $.fn.booklet.defaults = {
        ...
        previousControlText:  'Atras',                         // inline text for all 'previous' controls
        nextControlTitle:     'Pag. Siguiente',                 // text for title attributes of all 'next' controls
        previousControlTitle: 'Pag. Anterior',                 // text for title attributes of all 'previous' controls
